public class ArrayQueue {
    ...
    public void push(Object element) { //добавление в начало (head)
        //Pre: e != null
        assert element != null : "Element is null";
        ensureCapacity();
    ...
    public Object peek() { //Вернуть элемент из конца (tail)
        //Pre: size > 0
        assert size > 0 : "Queue is empty";
    ...
    public Object remove() { //удалить элемент из конца (tail)
        //Pre: size > 0
        assert size > 0 : "Queue is empty";
